...
//	http://bit2good.com
Shader "Bit2Good/SFS/Standard/Normal/Specular/Transparency"{
	Properties{
	...
	SubShader{
		...
		CGPROGRAM
		#pragma surface surf SmoothFresnel alpha fullforwardshadows approxview noambient
		...
		sampler2D	_Diffuse, _NormalMap, _SpecMap;
		half4		_Color;
