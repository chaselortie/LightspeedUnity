...
//	http://bit2good.com
Shader "Bit2Good/SFS/Prototype/Diffuse/Specular/Dissolve Self-Illumination"{
	Properties{
	...
	SubShader{
		...
		struct Input{
			half4 color : COLOR;
			half2 uv_Diffuse, uv_SpecMap, uv_MainTex, uv_Illumination;
			half3 viewDir;
		};
		
		sampler2D	_Diffuse, _SpecMap, _MainTex, _Illumination;
