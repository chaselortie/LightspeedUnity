...
//	http://bit2good.com
Shader "Bit2Good/SFS/Prototype/Normal/Dissolve Self-Illumination"{
	Properties{
	...
	SubShader{
		...
		struct Input{
			half4 color : COLOR;
			half2 uv_Diffuse, uv_NormalMap, uv_MainTex, uv_Illumination;
			half3 viewDir;
		};
		
		sampler2D	_Diffuse, _NormalMap, _MainTex, _Illumination;
