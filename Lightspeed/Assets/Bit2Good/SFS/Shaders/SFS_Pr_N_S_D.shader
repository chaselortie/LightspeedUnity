...
//	http://bit2good.com
Shader "Bit2Good/SFS/Prototype/Normal/Specular/Dissolve"{
	Properties{
	...
	SubShader{
		...
		struct Input{
			float4 	color : COLOR;
			half2 	uv_Diffuse, uv_NormalMap, uv_SpecMap, uv_MainTex;
			half3 	viewDir;
		};
		
		sampler2D	_Diffuse, _NormalMap, _SpecMap, _MainTex;
